...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move-msg:<Num> is deprecated: use move-msg:Num instead.")))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move-msg:num2-val is deprecated.  Use move-msg:num2 instead.")
  (num2 m))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move-msg:num-val is deprecated.  Use move-msg:num instead.")
  (num m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "b6346e706caa49d5ab50c519a7d60cf0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "b6346e706caa49d5ab50c519a7d60cf0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "int64 num2~%int64 num~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "int64 num2~%int64 num~%~%~%"))
